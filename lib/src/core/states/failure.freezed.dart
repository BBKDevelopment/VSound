...
abstract class $FailureCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, String message, String? code});
}
...
class _$FailureImpl implements _Failure {
  const _$FailureImpl({required this.title, required this.message, this.code});
  ...
  @override
  String toString() {
    return 'Failure(title: $title, message: $message, code: $code)';
  }
...
abstract class _Failure implements Failure {
  const factory _Failure(
      ...
      final String? code}) = _$FailureImpl;
